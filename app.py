...
def intelligent_score_contour(cnt, img_area, hierarchy, idx):
    ...
    if area < 50:  # Remove small specks
        return 0
    ...
    score = 0
    if rel_area > 0.0005:  # Require sufficient relative area
        score += 1
    if 0.3 < solidity <= 1.0:
        score += 1
...
if uploaded_file:
    ...
    # ✅ Adaptive thresholding for multi-tone contrast handling
